...
const jiya_panel = document.getElementById("info-panel-jiya");
const jiya_div = document.getElementById("info-div-jiya");
jiya_panel.addEventListener("mouseenter", () => {
    jiya_div.classList.remove("hidden");
})

jiya_panel.addEventListener("mouseleave", () => {
    jiya_div.classList.add("hidden");
})
